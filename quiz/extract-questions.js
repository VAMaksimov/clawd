 ...
 * 
 * ⚠️ ВАЖНО: Используйте вместо этого файл extract-questions-v2.js
 * Версия 2 использует localStorage и автоматически переходит между страницами,
 * сохраняя прогресс между перезагрузками.
 * 
 * Инструкция:
 * 1. Откройте тест на первой странице
 * 2. Откройте консоль браузера (F12 -> Console)
 * 3. Скопируйте и вставьте скрипт из extract-questions-v2.js
 * 4. Нажмите Enter
 * 5. Скрипт будет автоматически переходить между вопросами
 * 6. Когда все собраны, результат выведется в консоль
 */
